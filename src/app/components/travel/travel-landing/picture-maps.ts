...
export class PictureMaps{
    ...
    static BransonMap:Map<string, string> =  new Map<string, string>(
    [
    ...
    static CedarPointMap:Map<string, string> =  new Map<string, string>(
    [
    ...
    static ChicagoMap:Map<string, string> =  new Map<string, string>(
    [
    ...
    static DollywoodMap:Map<string, string> =  new Map<string, string>(
    [
    ...
    static KingsIslandMap:Map<string, string> =  new Map<string, string>(
    [
    ...
    static MammothMap:Map<string, string> =  new Map<string, string>(
        [
            ['1', "ab1f4e2f-c09e-436e-8519-da9a9e857700"],
            ['2', "20a7c90f-4082-4279-f89e-7b24c6ba1000"],
            ['3', "22d9db18-2df4-4674-2c19-acff47354200"],
            ['4', "f6c65620-0dff-4cbe-ff9d-9dc6495e0e00"],
            ['5', "1398a1ac-64b1-4e3b-c39f-f2fdeeda6f00"],
            ['6', "e947cc89-5fdb-4c1f-91f3-9035fa9e8100"],
            ['7', "bbf90223-df9d-4822-2da0-cb0119cd9b00"],
            ['8', "f6250c9d-c025-4b4c-e2d5-40939a46df00"],
            ['9', "20d13ca1-b716-4aba-c2bd-96bce9e97300"],
            ['10', "5798cf49-6105-491b-5334-9b401d61cc00"],
            ['11', "ada17dd6-9ffd-4dcb-533d-da6653e5ce00"],
            ['12', "5f9a73d6-d550-410c-512e-692affe45700"],
            ['13', "62a73027-4585-4bd4-4e3b-af30adbf2b00"],
            ['14', "6f97c66f-3c64-4dc9-debd-ae813e80e600"],
            ['15', "c99a4ed1-e17e-4e68-aee9-98e7ad2c7e00"],
            ['16', "7f2d1e48-8b6a-446a-8ffa-7ce09939b400"],
            ['17', "16ace333-38b3-4ada-cf55-5c9724993700"],
            ['18', "a4e6e05f-27e8-4e65-8eb4-54797956b800"],
            ['19', "cd7c081b-f14d-4dd6-8e01-c6f2eda9a900"],
            ['20', "89f904e5-f394-4da1-90fc-d9edad05cc00"],
            ['21', "b8fcaa66-9906-45ee-5a1c-1812fc390e00"],
            ['22', "970f3f31-e7f5-4e63-b877-592b84f11800"],
            ['23', "1e92b37d-7d6c-40d0-41a4-541218857c00"],
            ['24', "aecc9d40-9ea7-4689-0937-76d304112900"],
            ['25', "4700475c-9fb6-4739-532f-e25df224f900"],
            ['26', "cf1f473b-66b7-42b1-4cff-b9058dec6300"],
            ['27', "0e2659c5-9a65-4f96-be62-6c2d388d8200"],
            ['28', "0bbb0842-fffd-4f6b-2c63-208364e80800"],
            ['29', "a85a2296-db69-4b6a-45a8-b0c33877d600"],
            ['30', "4f0686e1-74a9-45bc-181f-047c70409d00"],
            ['31', "cb8187ce-5aae-46d6-a64e-672e3ed0ae00"]
        ]
    );

    static MichiganMap:Map<string, string> =  new Map<string, string>(
    [
        ...
        ['29', "1a964462-41ff-4dcf-d4a7-d29eb06da300"],
        ['30', "16c2c6ef-20aa-45ae-32d4-a330daa0f100"],
        ['31', "150f8fe7-246e-49b3-ac18-006a5966d300"],
        ['32', "bffe1f3b-c3e3-480b-48b6-51509fb01a00"]
    ]
    );    

    static WashingtonMap:Map<string, string> =  new Map<string, string>(
    [
